...
"border-color: rgb(0, 255, 0);")
        ...
        self.textEdit.setGeometry(QtCore.QRect(410, 0, 381, 451))
...
"border-color: rgb(0, 255, 0);")
        ...
        self.menubar = QtWidgets.QMenuBar(parent=SnifferWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 802, 21))
        self.menubar.setObjectName("menubar")
        self.menuFile = QtWidgets.QMenu(parent=self.menubar)
        self.menuFile.setObjectName("menuFile")
        SnifferWindow.setMenuBar(self.menubar)
    ...
    def follow_click(self, qmodelindex):
        ...
        self.textEdit.append(str(self.record_keep[ind].get_data('port_dst')))
        self.textEdit.append("-------SEQ/ACK---------")
        self.textEdit.append(str(self.record_keep[ind].get_data('seq_number')))
        ...
        self.textEdit.append("-------PAYLOAD---------")
        hexinfo = self.record_keep[ind].get_data('payload')
        
        self.textEdit.append((self.record_keep[ind].get_data('payload')))

        if 'POST' in hexstr(hexinfo):
            split = hexstr(hexinfo).split("..")
            self.textEdit.clear()
            self.textEdit.append("POST IDENTIFIED")
            for i in split[1:]:
    ...
    def retranslateUi(self, SnifferWindow):
        ...
        self.menuFile.setTitle(_translate("SnifferWindow", "File"))
